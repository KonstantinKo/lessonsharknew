...
<div class="thepower_texts"><h1>A simpler, safer, smarter way to find a Teacher.</h1></div>
					...
					<div id="slides">
						...
						<tr valign="top">
						  <td >
							 <div style="text-align:center;width:331px;margin-bottom: 12px;">
							  <span class="home_steps_text"><h2>Find</h2></span>
							 </div>
						  ...
						  <td>
							 <div style="text-align:center;width:330px;margin-bottom: 12px;">
							  <span class="home_steps_text"><h2>Book</h2></span>
							 </div>
						...
						<td>
							<div style="text-align:center;margin-bottom: 12px;">
							  <span class="home_steps_text" ><h2>Learn</h2></span>
							</div>
