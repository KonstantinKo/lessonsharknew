<div id="navigation">
	<ul>
	   ...
	   <h3 style="font-size:15px;">Lessonshark Details</h3>
            <ul>
               
		<li><?php echo $html->link(__('Lessonshark And Teacher Details', true), array('plugin' => 0, 'controller' => 'users', 'action' => 'detail', 'admin'=>true)); ?></li>
		<li><?php echo $html->link(__('Student Details', true), array('plugin' => 0, 'controller' => 'users', 'action' => 'student', 'admin'=>true)); ?></li>
