...
/*		array (
	...
	$cfg['ilibs'] = array (																// image library path with slashes; absolute to root directory - please make sure that the directories have write permissions	
		array (																		
			'value'   	=> 'D/wamp/www/blossman/app/img/webroot/contentUploads/',												
			'text'    	=> 'contentUploads',
		),
		array (
			'value'   	=> 'D/wamp/www/blossman/app/webroot/img/contentGallery/', 				
			'text'    	=> 'contentGallery',
		),	
	);
	...
	$cfg['ilibs_dir'] 	   = array('D:/wamp/www/blossman/app/webroot/contentUploads/');						   	// image library path with slashes; absolute to root directory - please make sure that the directories have write permissions
