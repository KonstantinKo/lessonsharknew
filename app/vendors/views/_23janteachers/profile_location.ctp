...
<li>
	...
	<div style="width:300px; float:left;">
		<select id="homestudio" name="data[TeacherLocation][type]" >
			<option value="" selected="selected">Select type</option><option value="home" selected="selected" >home</option>
...
<div id="studio1">
	...
	<div style="width:203px;float:left" >Zip</div>
	<div style="width:300px; float:left;">
	<input id="TeacherLocatonZip" name="data[TeacherLocation][zip1]" type="text" />
	</div>
	</li>
   </div>
   <li/>
