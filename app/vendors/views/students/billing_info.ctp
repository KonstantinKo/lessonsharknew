...
<?php echo $javascript->link('wepay');?>
<?php $paymentval=1000; ?>
<script>
...
<div class="book_lesson_info_twomain" >
	...
	<div class="book_lesson_left"  >
	  ...
	  <div class="book_lesson_right">
		...
		<div class="billing_information_rights">
			...
			<div class="billing_celender_inner">
				<div class="enter_billing_iner_main">
					...
					<?php $total=0; foreach($discipline as $package)
				{?>
					<div class="enter_billing_iner_main">
						<div class="iner_lefts">12/15/2010</div>
						<div class="iner_rights"><?php $total+= $package['TeacherDesciplineField']['rate']; echo '$'.$package['TeacherDesciplineField']['rate'];  ?></div>
		...
		<div class="enter_total">Total:$<?php echo $total; ?></div>
		<div class="clr"></div>
		<div class="enter_total_two">Due Now:$<?php echo $total; ?></div>
...
<div class="billing_information_main"  >
		<?php $total=0; foreach($discipline as $package)
					{
					 $total+= $package['TeacherDesciplineField']['rate']; 
				  } ?> 
	...
	<form name="_xclick" action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
				...
				<input type="text"   name="business" class="enter_billing_input"/>
