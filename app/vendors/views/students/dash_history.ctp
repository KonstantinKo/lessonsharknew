        ...
        <div class="student_part_left">
            <div class="student_iner_left_middle">
                ...
                <div class="studen_middle_inner_second">
                    ...
                    <div class="student_date_last"><span class="span_color"><?php if($comment=='') { ?><a href="/dev1/students/comment" id="comment"><?php echo $html->image('plus_aad_03.jpg'); ?></a><?php }else { echo $comment; } ?></span></div>
            ...
            <div class="student_iner_left">
                <div class="student_lesson_details_left">
                    ...
                    <div class="student_lesson_details_left_iiner">
                        ...
                        <div class="student_edit_bu"><a href="/dev1/students/editShedule" id="login"><?php echo $html->image('add_bu_18.jpg'); ?></a></div>
