...
<ul>
 ...
 <li>
	...
	<li><div style="width:203px;float:left" >Label</div><div style="width:300px; float:left;"><input id="TeacherMediaLabel" name="data[TeacherMedia][label][]" type="text"  value="<?php  echo $media1['TeacherMedia']['label'] ?>"/><input type="hidden" value="<?php  echo $media1['TeacherMedia']['id'] ?>"name="data[TeacherMedia][hidd][]" ></div></li>
	<li><div style="width:203px;float:left" >Url</div><div style="width:300px; float:left;"><input id="TeacherMediaUrl" name="data[TeacherMedia][url][]" type="text" value="<?php  echo $media1['TeacherMedia']['url'] ?>"/></div></li>
