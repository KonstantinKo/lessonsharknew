<?php echo $javascript->link('tinymce/jscripts/tiny_mce/tiny_mce'); ?> 
   ...
   <div class="single"><h2>Content Management System</h2> </div>
      ...
      <?php //echo $form->create('Content', array('url' => '/admin/content/editCat/'.$id));?>
      <?php echo $form->create('Content',array('id'=>'contentEditForm','url' => '/admin/content/editRoot',$id,'name'=>'frmCreate','enctype'=>'multipart/form-data')); ?>
