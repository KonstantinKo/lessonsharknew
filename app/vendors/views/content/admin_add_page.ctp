...
<script type="text/javascript">
	tinyMCE.init({
      ...
      <?php echo $form->create('Content',array('id'=>'contentAddForm','url' => '/admin/content/add','name'=>'frmCreate','enctype'=>'multipart/form-data')); ?>
...
echo '  </select>';?></td>    
      ...
      <?php
       ...
       {
          ?>
            <input type="hidden" value="<?php echo $id?>" name="data[Content][parent_id]" >
          <?php
       }
      ?>
      <tr>
