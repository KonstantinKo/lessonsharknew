...
<div class="topBar">
  <div> <a  style="text-decoration:none; color:black;" href="/lessonshark1/admin/users/home">User Management</a> / Teacher Management</a></div>
  <fieldset><legend onclick="Effect.toggle('showUserAdd','blind', {duration:0.50}); return false"> Add Teacher </legend>
      ...
      <?php echo $form->create('User');?>
        <ul>
          ...
          <li>
          <?php echo $ajax->submit('+ Add', array('url'=> array('controller'=>'users','action'=>'addTeacher'), 'update' => 'message','indicator'=>'loader', 'div'=>true, 'style'=>'width: 80px;float:right;margin-right:150px; ')); ?>
          </li>
        </ul>
    <?php echo $form->end(); ?>
      </div>
...
<!-- START: User Listing -->
<fieldset><legend>Search Teacher </legend>
    <div class="topBar">
      <fieldset><legend onclick="Effect.toggle('showUserFilter','blind', {duration:0.50}); return false"> Filter </legend>
        ...
        <div id="showUserFilter">
            ...
            <ul>
              ...
              <?php echo $ajax->submit('Search', array('url'=> array('controller'=>'users','action'=>'searchTeacher'), 'update' => 'user_listing','indicator'=>'loader_listing', 'div'=>true, 'style'=>'margin-right:125px;float:right;width:80px;')); ?>
              </li>
            </ul>
          <?php echo $form->end(); ?> 
...
<div id="loader_listing" style="display:none; relative:absolute; margin-top:2px;"><?php echo $html->image("sliderDot.gif"); ?></div>
    ...
    <div id="user_listing"><?php  echo $this->requestAction('/admin/users/searchTeacher'); ?></div>
