...
<div class="table_main">
    ...
    <div class="table_main_right">
        ...
        <div class="table_main_right_img"><a href="/dev1/teachers/attendance" id="attendance"><?php echo $html->image('detal_img.png'); ?></a></div>
...
<div class="clr"></div>
<div class="make_up_img"><a href="/dev1/teachers/makeup" id="makeup" onclick="getPopLesson()"><?php echo $html->image('make_up_img.png'); ?></a></div>
