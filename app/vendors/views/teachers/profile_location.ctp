...
<div class="new_edit_back"></div>
		...
		<div class="location_middle_main">
			<div class="location_middle_left">
				...
				{?>
			 		<div class="location_middle_one_txer"><?php echo $location['TeacherLocation']['city']; ?></div>
				<?php  } ?>				
				
				<div class="clr"></div>
				<div class="location_bootem_btn">
					<?php echo $html->image('add_plus.png'); ?>
					<?php echo $html->image('delete_btn.png'); ?>
					<?php echo $html->image('edit_loction.png'); ?>
					
				</div>
			</div>

<?php    echo $form->create('TeacherMedias', array('url' => array('controller' => 'teachers', 'action' => 'profileLocation',$id)));?>
